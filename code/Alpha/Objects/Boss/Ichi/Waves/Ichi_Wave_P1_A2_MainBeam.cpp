...
IchiWaveP1A2MainBeam::IchiWaveP1A2MainBeam(Systems::MeshAsset* pMesh, Systems::MaterialInstanceAsset* pMaterial, uint32_t bulletCount, float rotationOffset)
	: IBulletWave()
...
IchiWaveP1A2MainBeam::~IchiWaveP1A2MainBeam()
{
}

void IchiWaveP1A2MainBeam::Init(Bullets& bullets)
{
	//allocate bullets
...
void IchiWaveP1A2MainBeam::Destroy(Bullets& bullets)
{
	bullets.Free(m_startId, m_count);
}

void IchiWaveP1A2MainBeam::Start(Bullets& bullets, const Core::Vec4f& /*pos*/)
{
	m_enableSpawn = true;
...
void IchiWaveP1A2MainBeam::BuildRenderable(Bullets& bullets, Systems::RenderableScene& scene)
{
	if (!m_isAlive)
		return;
...
void IchiWaveP1A2MainBeam::SetSpawnPosition(const Core::Vec4f& spawnPosition)
{
	m_spawnPosition = spawnPosition;
}

void IchiWaveP1A2MainBeam::SetSpawnSpeed(const Core::Vec4f& spawnSpeed)
{
	m_spawnSpeed = spawnSpeed;
}

void IchiWaveP1A2MainBeam::DisableSpawn()
{
	m_enableSpawn = false;
}
