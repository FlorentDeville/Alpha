...
void RenderModule::Render(const Renderable& renderable, const DirectX::XMMATRIX& wvp, const DirectX::XMVECTOR& color)
{
	...
	m_pRenderCommandList->SetGraphicsRoot32BitConstants(1, sizeof(DirectX::XMVECTOR) / 4, &color, 0);
